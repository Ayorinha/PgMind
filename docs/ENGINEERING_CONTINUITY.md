...
## Ecosystem position
 PostgreSQL and hybrid vector retrieval

## Current mission
Data/retrieval layer: combines PostgreSQL-backed records with lexical and vector-style retrieval for production-oriented hybrid search.
